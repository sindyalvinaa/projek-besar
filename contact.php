...
<html lang="en">
  <head>
    ...
    <div class="container">
        ...
        <h3 class = "display-5"><span class = "font-weight-bold">Grand Opening Nadiraa Hijab Store 2 </span></h3>
        <hr><br><br>
    <div class="wpb_video_wrapper"><div class="video-container"><iframe title="Grand Opening Nadiraa Hijab Store 2" 
    width="1000" height="600" src="https://www.youtube.com/embed/jVcqWVzRdVA?feature=oembed" frameborder="0" 
    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div></div>
...
<div class="vc_separator wpb_content_element vc_separator_align_left vc_sep_width_100 vc_sep_border_width_3 vc_sep_pos_align_left
 ...
 style="border-color:#a8e8e2;" class="vc_sep_line"></span></span>
	...
	<h5>Yogyakarta</h5>
    <p>0857-1135-4835<br/>
    Jln. Pintu Selatan UPN no.11, Ngropoh, Condongcatur, Kec. Depok, Kab. Sleman, Daerah Istimewa Yogyakarta 55281</p>
		</div>
	</div>
...
<div class="vc_separator wpb_content_element vc_separator_align_left vc_sep_width_100 vc_sep_border_width_3 vc_sep_pos_align_left
 ...
 style="border-color:#a8e8e2;" class="vc_sep_line"></span></span>
	...
	<div class="wpb_text_column wpb_content_element " >
		<div class="wpb_wrapper">
			<p><strong>All day</strong>: 9am to 10pm</p>
		</div>
	</div>
        ...
        <div class="row footer-body">
			</div><h4 class="icon_box_title">Admin Jabodetabek</h4><a class="icon_box_read_more" 
